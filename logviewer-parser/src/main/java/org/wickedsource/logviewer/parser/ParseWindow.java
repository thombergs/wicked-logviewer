...
public interface ParseWindow {
	 ...
	 * {@link #getFocusLine()} does not slide the window forward a step.
	 * 
	 ...
	 * 
	 * @returns the next line that is in the focus of this window or null if the
	 *          end of the stream has been reached.
	 * @throws IOException
	 *             in case the next line cannot be read from the input stream.
	 */
	String slideForward();
	 ...
	 * 
	 * @param distance
	 *            the number of lines to look ahead. Must be greater or equal 0.
	 ...
	 * @throws IOException
	 *             in case a line cannot be read from the input stream.
	 */
